 ...
 */
MapTo('wknd-app/components/navigation')(NavigationV1Component, {isEmpty: NavigationV1IsEmptyFn});
MapTo('wknd-app/components/separator')(SeparatorV1Component);

MapTo('wknd-app/components/container')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});
MapTo('wknd-app/components/experiencefragment')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});

MapTo('wknd-app/components/download')(DownloadV1Component,{isEmpty: DownloadV1IsEmptyFn});
MapTo('wknd-app/components/languagenavigation')(LanguageNavigationV1Component);
MapTo('wknd-app/components/list')(ListV2Component, {isEmpty: ListV2IsEmptyFn});
MapTo('wknd-app/components/breadcrumb')(BreadCrumbV2Component, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('wknd-app/components/button')(ButtonV1Component, {isEmpty: ButtonV1IsEmptyFn});
MapTo('wknd-app/components/image')(ImageV2Component, {isEmpty: ImageV2IsEmptyFn});
MapTo('wknd-app/components/title')(TitleV2Component, {isEmpty: TitleV2IsEmptyFn});

MapTo('wknd-app/components/accordion')(AccordionV1Component);
MapTo('wknd-app/components/tabs')(TabsV1Component);
...
LazyMapTo('wknd-app/components/teaser')(TeaserV1Component);
...
LazyMapTo('wknd-app/components/carousel')(CarouselV1Component);
...
LazyMapTo('wknd-app/components/text')(LazyTextModule, TextEditConfig);